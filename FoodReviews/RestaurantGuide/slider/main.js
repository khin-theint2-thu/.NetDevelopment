...
(function() {
    ...
    $('.slider_8').jUsualSlider({
        slideClass: 'slider__item',
        btns: $('.slider_8 .slider__nav'),
        activeIndx: 3,
        slidesPerPage: 3,
        autoSlide: false,
        afterSlide: function (indx) {
            $('.slider_8 .slider__info').text('Slide ' + (indx + 1))
        }
    });

    $('.slider_6').jUsualSlider({
        slideClass: 'slider__item',
        btns: $('.slider_6 .slider__nav'),
        activeIndx: 3,
        slidesPerPage: 3,
        autoSlide: false,
        afterSlide: function (indx) {
            $('.slider_6 .slider__info').text('Slide ' + (indx + 1))
        }
    });

    $('.slider_7').jUsualSlider({
        slideClass: 'slider__item',
        btns: $('.slider_7 .slider__nav'),
        activeIndx: 3,
        slidesPerPage: 3,
        autoSlide: false,
        afterSlide: function (indx) {
            $('.slider_7 .slider__info').text('Slide ' + (indx + 1))
        }
    });
